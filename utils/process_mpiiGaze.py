...
We know the annotations We also annotated 10,848 images with 12 facial landmarks, face bounding box, 
two eye bounding boxes, and pupil position.
"""
...
xy6 is the pupil location for the right eye We ignore the other points for now
"""
def view_gaze():
...
Here we load the .mat data which as it is a Matlab file a bit messy to read in Python but with scipy and
 a little determination we can figure it out
"""
def read_normalizedData():
